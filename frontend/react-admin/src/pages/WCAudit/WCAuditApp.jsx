...
//       setResult(data);
//       setPhase("done");
//       onDataCleared?.();         // refresh the cases list in the parent
//     } catch (err) {
//       setErrMsg(err.response?.data?.detail || err.message || "Unknown error");
//       setPhase("error");
//     }
//   };
...
//               "HITL Reviews",
//               "Audit Reports",
//               "Policy Class Codes & Officers",
//             ].map(item => (
//               <div key={item} style={{ display:"flex", alignItems:"center",
//                 gap:6, fontSize:12, color:"#78350F" }}>
...
//               This action <strong>cannot be undone</strong>. All audit cases, policies, payroll
//               records, variance lines, HITL reviews, and reports will be permanently deleted
//               from the database.<br /><br />
//               Type <strong style={{ color:C.red }}>{CONFIRM_PHRASE}</strong> to continue:
//             </div>
//             <input
//               value={confirmTxt}
...
//             <div style={{ display:"flex", gap:10 }}>
//               <button
//                 disabled={confirmTxt !== CONFIRM_PHRASE}
//                 onClick={handleWipe}
...
//               {[
//                 { label:"Audit Cases", value: result.deleted_cases    ?? 0 },
//                 { label:"Policies",    value: result.deleted_policies  ?? 0 },
//                 { label:"Total Rows",  value: result.total_deleted     ?? 0 },
//               ].map(({ label, value }) => (
