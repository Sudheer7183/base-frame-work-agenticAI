      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          <div style={{
            ...
            <img
              // src="/images/logo.jpeg"   // 👈 change this
              src="http://164.52.216.131/SmartPay_Primary_Logo.png" 
              alt="icon"
              style={{
                width: 70,
                height: 50,
          ...
          <div>
            ...
            <div style={{ fontSize: 15, fontWeight: 800, lineHeight: 1.2 }}>Workers' Comp Audit AI</div>
          </div>
        </div>
        ...
        <nav style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
          ...
          <button
            ...
            onClick={logout}
            title="Logout"
            style={{ color: '#feffff', background: "None" }}
          >
            <LogOut />
          </button>
          {/* <NavLink
